...
<body>
  ...
  <div class="container">
    <div class="form-container">
      ...
      <form class="form" action="RegisterData" method="get">
        <div class="form-control">
          <input type="text" name="t1" class="input username" placeholder="Username" required />
        </div>
        <div class="form-control">
          <input type="text" name="t2" class="input username" placeholder="Name" required />
        </div>
        <div class="form-control">
          <input type="text" name="t3" class="input username" placeholder="Email" required />
        </div>
        <div class="form-control">
          <input type="password" name="t4" class="input password" placeholder="Password" required />
        </div>
      ...
      <div class="sign-up">
        ...
        <a href="login.jsp"><button class="btn btn-sign-up">Login</button></a>
      </div>
